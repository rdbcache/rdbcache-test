...
class TestDelkeyController extends TestController
{
    ...
    public function actionSimpleWithSync() {
        ...
        // delkey
        //
        $api = '/rdbcache/v1/delkey/'.$key.'/sync';
        $response = $this->createRequest(true)
            ->setMethod('get')
            ->setApi($api)
            ->send();
    ...
    public function actionWithTable() {
        ...
        // delkey
        //
        $api = '/rdbcache/v1/delkey/'.$key.'/tb1';
        $response = $this->createRequest(true)
            ->setMethod('get')
            ->setApi($api)
            ->send();
    ...
    public function actionWithTableAndSync() {
        ...
        // delkey
        //
        $api = '/rdbcache/v1/delkey/'.$key.'/tb1/sync';
        $response = $this->createRequest(true)
            ->setMethod('get')
            ->setApi($api)
            ->send();
    ...
    public function actionWithPostAndSync() {
        ...
        // delkey
        //
        $api = '/rdbcache/v1/delkey/tb1/sync';
        $response = $this->createRequest(true)
            ->setFormat(\yii\httpclient\Client::FORMAT_JSON)
            ->setMethod('post')
            ->setApi($api)
